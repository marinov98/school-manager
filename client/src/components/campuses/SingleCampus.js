        ...
        if(this.state.isEditOn){
            return(
                <div>
                    ...
                    <p className="description">Hunter College is one of the constituent colleges of the City University of New York, an American public university.
            ...
            return (
                <form onSubmit={this.handleSubmit}>
                    <label>
                        First name:
                        <input name="tempAddress" type="text" value={this.state.tempAddress} onChange={this.handleChange}></input>
                    </label>
                    <br></br>
